...
const endpoints = {
    ...
    'addLike': '/data/likes',
    'getLikes': (itemId) => `/data/likes?where=albumId%3D%22${itemId}%22&distinct=_ownerId&count`,
    'hasLiked': (itemId, userId) => `/data/likes?where=albumId%3D%22${itemId}%22%20and%20_ownerId%3D%22${userId}%22&count`,

...
const detailsTemplate = (itemPromise) => html`<div class="container">
...
const itemTemplate = (item, isOwner, onDelete) => html`
 <div class="col-md-4">
        <div class="card text-white bg-primary">
            <div class="card-body">
                <img src=${item.img.slice(0,1)=='.'?item.img.slice(1):item.img} />
            </div>
        </div>
    </div>
    <div class="col-md-4">
...
async function loadItem(id, onDelete) {
    ...
    const isOwner = getUserData().id == item._ownerId;

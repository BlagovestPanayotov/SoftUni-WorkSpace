...
const formTemplate = (item, onSubmit, errorMessage, errors) => html`
        <form @submit=${onSubmit}>
            ${errorMessage ? html`<div class="form-control-label error">${errorMessage}</div>` : null}
            <div class="row space-top">
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                    ...
                    <div class="form-group">
                        ...
                        <input class=${'form-control' + (errors.make ? ' is-invalid' : ' is-valid')} id="new-material" type="text" name="material" value=${item.material}>
                    </div>
